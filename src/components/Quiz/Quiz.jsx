...
export default function Quiz() {
  ...
  const calcularResultado = () => {   // <- Essa função confere se todas as perguntas foram respondidas
  ...
  return (
    <div className='div'>
      {resultado !== null ? (
        ...
        <div>
        <h2>Jogue o Quiz de conhecimentos gerais!</h2>
          <h2 className='h2'>Pergunta {indicePergunta + 1}</h2>
